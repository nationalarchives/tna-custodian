...
| DynamoDb    | Reference Counter Table specific rules | Set of checks specific to the reference counter table. See [README][refererence-counter-readme] for details | Not Applicable              |
